...
Наприклад:
- 7z (7-Zip) - популярна програма для стискання файлів з дуже високим коефіцієнтом стискання. Підтримує багато форматів архівів.
- rar / unrar - програми для створення та розпакування архівів формату RAR. Часто використовуються для обміну файлами між різними операційними системами.
